...
import { User, Bell, CreditCard, FileText, HelpCircle, LogOut, ChevronRight, Settings } from "lucide-react";
        ...
        <div className="p-6 pt-8 text-center">
          ...
          <div className="flex justify-center gap-4 mt-4">
            <div className="text-center">
              <p className="font-display font-bold text-lg text-primary-foreground">12</p>
              <p className="text-xs text-primary-foreground/70">Commandes</p>
            </div>
            <div className="w-px bg-primary-foreground/20" />
            <div className="text-center">
              <p className="font-display font-bold text-lg text-primary-foreground">4.9</p>
